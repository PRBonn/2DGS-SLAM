...
class ASMKMethod:
    ...
    def build_ivf_I(self, *columns, pre_builder= None, distractors_path=None, cache_path=None, step_params=None):
        """The second step of the method - building the ivf (or loading from cache)
        ...
        return self.add_ivf_builder(builder), builder
