...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, radii, geomBuffer, binningBuffer, imgBuffer, contributions = _C.rasterize_gaussians(*args)
        ...
        return color, radii, depth, contributions

    @staticmethod
    def backward(ctx, grad_out_color, grad_radii, grad_depth, grad_contributions):
